...
//        System.out.println(str);
        ...
        jtp.Instrument[0].PCM[0] = 0;
        jtp.Instrument[0].PCM[1] = 1;
        jtp.Instrument[0].PCM[2] = 2;
        jtp.Instrument[0].PCM[3] = 3;
        jtp.Instrument[0].PCM[4] = 4;
        jtp.Instrument[0].PCM[5] = 5;
        jtp.Instrument[0].PCM[6] = 6;
        jtp.Instrument[0].PCM[7] = 7;
        jtp.Instrument[0].PCM[8] = 8;
        jtp.Instrument[0].PCM[9] = 9;
        jtp.Instrument[0].PCM[10] = 10;
        jtp.Instrument[0].PCM[11] = 11;
        jtp.Instrument[0].PCM[12] = 12;
        jtp.Instrument[0].PCM[13] = 13;
        jtp.Instrument[0].PCM[14] = 14;
        jtp.Instrument[0].PCM[15] = 15;
